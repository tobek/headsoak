...
- TOC links should work `10m`
- bring viz above fold (and no need for detecting scroll)
- background image visible in alternating things
- ribbon?
- confirm features stuff
- RESPONSIVE
- demo note
    - adding tag animation
    - what to do with note tag dropdown?
    - note actions? hide, or keep visible but clicks do nothing?
        - pin/archive won't work cause tags don't exist?
